...
sqrt(checkEstLowPSUlowSSU$mean.sq.error) / sqrt(checkEstLowPSUhighSSU$mean.sq.error)
sqrt(checkEstHighPSUlowSSU$mean.sq.error) / sqrt(checkEstHighPSUhighSSU$mean.sq.error)

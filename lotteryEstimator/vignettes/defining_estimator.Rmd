...
checkEst <- checkEstimatorsExamplePopulation(stage1HTtotal, total, 500, 20, 2)

se <- function(x){sqrt(diag(stage1HTvariance(x)))}
checkEstVar <- checkEstimatorsExamplePopulation(se, sqrt(checkEst$mean.sq.error), 500, 20, 2)
